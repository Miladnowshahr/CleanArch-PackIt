...
namespace PackIt.UnitTests.Application
{
    public class CreatePackingListWithItemsHandlerTests
    {
        ...
        [Fact]
        public async Task HandleAsync_Throws_PackingListAlreadyException_When_List_With_Same_Name_Already_Exists() {
            ...
            exception.ShouldBeOfType<PackingListAlredyExistException>();
        ...
        {
            var command = new CreatePackingListWithItems(Guid.NewGuid(), "MyList", 10, Gender.Female, new LocalizationWithModel("Warsow","Poland"));
